...
<section className="text-gray-600 body-font relative" id='contact'>
    <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div
            ...
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                <div className="lg:w-1/2 px-6">
                    ...
                    <p className="mt-1">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sapiente</p>
                </div>
        ...
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Laissez nous un message</h2>
            <p className="leading-relaxed mb-5 text-gray-600">Lorem ipsum dolor sit amet consectetur.
            </p>
            ...
            <p className="text-xs text-gray-500 mt-3">Nous vous offrons un support 24h/24, 7J/7
                artisan.</p>
        </div>
    </div>
</section>
